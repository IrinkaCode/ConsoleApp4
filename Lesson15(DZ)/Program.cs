...
double avg12 = ((mas1.Sum() + mas2.Sum()) / 2.0);
double avg34 = ((mas3.Sum() + mas4.Sum()) / 2.0);
double productMas = avg12 * avg34;

Console.WriteLine("1 массив: " + string.Join(",", mas1));
Console.WriteLine("2 массив: " + string.Join(",", mas2));
Console.WriteLine($"Среднее арифметическое 1 и 2 массивов = {avg12}");
Console.WriteLine("3 массив: " + string.Join(",", mas3));
Console.WriteLine("4 массив: " + string.Join(",", mas4));
Console.WriteLine($"Среднее арифметическое 3 и 4 массивов = {avg34}");
Console.WriteLine($"Произведение средних арифметических:");
Console.WriteLine($"Среднее арифметическое 1 и 2 массивов = {avg12}");
Console.WriteLine($"Среднее арифметическое 3 и 4 массивов = {avg34}");
Console.WriteLine($"Произведение = {productMas}");